import { Clock, House, PawPrint, Star } from "lucide-react";
import React from "react";

const statsData = [
  { value: "2,500+", label: "Pets Adopted", icon: <PawPrint /> },
  { value: "1,800+", label: "Happy Families", icon: <House /> },
...
const NumberDetails = () => {
  return (
    <section className="py-16 px-10 container mx-auto">
      ...
      <div className=" inset-0 bg-[radial-gradient(circle_at_top_right,var(--tw-gradient-stops))] from-orange-100 via-white to-white opacity-60 grid grid-cols-2 md:grid-cols-4 w-full">
